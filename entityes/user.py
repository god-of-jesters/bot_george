class User:
    def __init__(self, user_id: int, fio: str = None, team_number: int = None, role: str = None, num_badge: int = None, reiting: int = None, balance: int = None, date_registered: str = None):
